        ...
        WindowGroup {
            ContentView()
                .onAppear {
                    ...
                    print("🔧 [APP] Agent config workspace: \(agent.config.workspace)")

                    let workspace = URL(fileURLWithPath: agent.config.workspace)
                    print("🔧 [APP] Workspace URL: \(workspace.path)")
                    ocrManager.start(workspace: workspace)
                }
        }
